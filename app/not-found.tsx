...
const NotFoundPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="relative inline-block mb-8">
              <div className="text-9xl md:text-[12rem] font-black bg-linear-to-r from-white to-gray-200 bg-clip-text text-transparent relative z-10">
                404
              </div>
              {/* Glow Effect */}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              ...
              <Link href="/">
                <div className="flex items-center space-x-3 bg-white text-[#0A400C] px-8 py-4 rounded-2xl hover:shadow-2xl transition-all duration-300 shadow-xl font-semibold group cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {suggestedPages.map((page) => {
              ...
              return (
                ...
                >
                  <div className="bg-linear-to-br from-gray-50 to-white rounded-2xl p-6 border border-gray-200 hover:border-[#0A400C] hover:shadow-xl transition-all duration-300 h-full">
                    <div className="text-center">
                      <div className="inline-flex p-3 rounded-xl bg-linear-to-r from-[#0A400C] to-[#819067] mb-4 group-hover:scale-110 transition-transform duration-300">
      ...
      {/* Help Section */}
      <section className="py-16 bg-linear-to-r from-[#0A400C] to-[#819067] text-white">
