...
// Define the project type to match ProjectCard's expectations
type ProjectStatus = 'completed' | 'planning' | 'development';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* CTA Section */}
          <div className="mt-16 bg-linear-to-r from-[#0A400C] to-[#819067] rounded-3xl p-12 text-white text-center">
